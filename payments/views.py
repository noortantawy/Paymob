...
from .services import authorize_payment, authorize_payment_via_tcp
...
class PayTcpView(APIView):
    """authorizes the payment over a raw TCP socket using query-string encoding
    instead of HTTP + JSON.
    """
    ...
    def post(self, request):
        ...
        bank_response = authorize_payment_via_tcp(
            mid=terminal.merchant_id,
            tid=terminal.tid,
            amount=amount,
            currency=currency,
